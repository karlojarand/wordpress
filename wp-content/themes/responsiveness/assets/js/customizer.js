...
( function( $ ) {
                ...
                wp.customize( 'top_widgets_headline', function( value ) {
        value.bind( function( to ) {
            $( '.top-fullwidth-widget .widget .widget-title, .top-column-widget .widget h3' ).css( {
                'color':to
            });
        } );
    } );

                wp.customize( 'top_widgets_text', function( value ) {
        value.bind( function( to ) {
            $( '.top-fullwidth-widget .widget, .top-column-widget .widget, .top-fullwidth-widget .widget p, .top-column-widget .widget p' ).css( {
                'color':to
            });
        } );
    } );

                wp.customize( 'top_widgets_link', function( value ) {
        value.bind( function( to ) {
            $( '.top-fullwidth-widget .widget a, .top-column-widget .widget a, .top-fullwidth-widget .widget p a, .top-column-widget .widget p a' ).css( {
                'color':to
            });
        } );
    } );
	...
	wp.customize( 'blogname', function( value ) {
        ...
        value.bind( function( to ) {
            $( '.navicon:focus .fa-bars, .navicon:active .fa-bars, .navicon .fa-bars, .site-header .main-navigation ul li a, .site-header .main-navigation ul li a:hover, .site-header .main-navigation ul li a:visited, .site-header .main-navigation ul li a:focus, .site-header .main-navigation ul li a:active, .main-navigation ul li ul.childopen li:hover a, .main-navigation ul li ul.childopen li .active a' ).css( {
                'color':to
            });
        } );
    } );
        ...
        value.bind( function( to ) {
            $( '#secondary .widget cite, #secondary .widget, #secondary .widget p, #secondary .widget li, #secondary .widget td' ).css( {
                'color':to
            });
        } );
    } );
